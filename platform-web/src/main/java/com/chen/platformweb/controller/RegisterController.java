...
public class RegisterController {
    ...
    public String add_do(String applyType,String jbr_name,String jbr_number,String unitId,
                         String DATA,String upload_file,String standard) throws UnsupportedEncodingException {
        //准备一个申请列表
...
//        filename = fileService.saveFile(upload_file);
     ...
     * @param unitId 单位ID
     */
    @RequestMapping(value ="addSeal")
    public ModelAndView addSeal(String unitId,String userId,String businessSys) {
        String personId = personService.findPersonIdBySYS(businessSys,userId);
